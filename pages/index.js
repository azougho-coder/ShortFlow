  ...
  return (
    <>
      ...
      <section className="hp" style={{padding:"150px 40px 100px",maxWidth:900,margin:"0 auto",textAlign:"center"}}>
        <div className="mono" style={{display:"inline-flex",alignItems:"center",gap:8,border:"1px solid #1A1A1A",borderRadius:20,padding:"6px 16px",fontSize:12,color:"#3EFFA0",marginBottom:32,letterSpacing:".3px"}}>
        ...
        <div style={{marginTop:64,background:"#0A0A0A",border:"1px solid #1A1A1A",borderRadius:6,padding:0,textAlign:"left",maxWidth:560,margin:"64px auto 0",overflow:"hidden"}}>
          <div style={{display:"flex",alignItems:"center",gap:8,padding:"12px 16px",borderBottom:"1px solid #161616"}}>
          ...
          <div style={{padding:20}}>
            {[
              {label:"CLIP_RATING",content:<span className="mono" style={{color:"#3EFFA0",fontWeight:600,fontSize:13}}>FIRE ●●●</span>},
              ...
              <div key={i} style={{marginBottom:i<2?16:0}}>
                <div className="mono" style={{fontSize:10,color:"#555",letterSpacing:"1px",marginBottom:6}}>{item.label}</div>
                {item.content}
              </div>
            ))}
          </div>
      ...
      <section id="features" className="sp" style={{padding:"80px 40px",maxWidth:760,margin:"0 auto"}}>
        <div style={{marginBottom:8}}>
          <div className="mono" style={{fontSize:12,color:"#3EFFA0",letterSpacing:"1.5px",marginBottom:12}}>FEATURES</div>
          <h2 style={{fontSize:32,fontWeight:700,letterSpacing:"-.8px"}}>Everything you need to scale</h2>
        </div>
        {FEATURES.map((f)=>(
          <div key={f.num} className="feat-row">
            <div className="mono" style={{fontSize:14,color:"#3EFFA0",fontWeight:600,flexShrink:0,paddingTop:2}}>{f.num}</div>
            <div>
      ...
      <section style={{padding:"0 40px 80px",maxWidth:700,margin:"0 auto",textAlign:"center"}}>
        <div style={{background:"#0A0A0A",border:"1px solid #1A1A1A",borderRadius:6,padding:32}}>
          ...
          <div className="mono" style={{fontSize:12,color:"#666"}}>— SHORTS MANAGER, 6 CLIENTS</div>
        </div>
      </section>

      <section id="pricing" className="sp" style={{padding:"80px 40px",maxWidth:1000,margin:"0 auto"}}>
        <div style={{textAlign:"center",marginBottom:48}}>
          <div className="mono" style={{fontSize:12,color:"#3EFFA0",letterSpacing:"1.5px",marginBottom:12}}>PRICING</div>
        ...
        <div className="plans-g" style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:16,maxWidth:700,margin:"0 auto"}}>
          {PLANS.map((plan)=>(
            <div key={plan.name} className={`plan-card ${plan.highlight?"hl":""}`}>
              {plan.highlight&&<div className="mono" style={{display:"inline-block",background:"#3EFFA0",color:"#000",fontSize:11,fontWeight:700,padding:"3px 10px",borderRadius:3,marginBottom:16,letterSpacing:".5px"}}>MOST POPULAR</div>}
      ...
      <footer style={{borderTop:"1px solid #161616",padding:"24px 40px",textAlign:"center"}}>
        <div className="mono" style={{fontSize:13,color:"#555"}}>Short<span style={{color:"#3EFFA0"}}>Flow</span> — Built for Shorts managers &nbsp;·&nbsp; <a href="/privacy" style={{color:"#555",textDecoration:"none"}}>Privacy</a> &nbsp;·&nbsp; <a href="/terms" style={{color:"#555",textDecoration:"none"}}>Terms</a></div>
      </footer>
    </>
  );
}
